...
def farm_factory(farm_name, animal_description):
    ...
    for animal in animal_description:
        date_time = datetime.datetime.strptime(animal['birthdate'], '%d %B %Y')
        my_current_farm.add_animal(animal['type'], animal['sex'] ,date_time)
...
if __name__ == "__main__":
    ...
    with open('C:\\Users\\Damien\\Desktop\\EPSI\\Projet Python\\farm2.json') as json_file:
    ...
    for farms in data:
        ...
        farm_list.append(farm_factory(farms['Farm_name'], farms['Animal list']))
